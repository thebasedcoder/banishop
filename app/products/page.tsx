...
import { ProductCard } from '@/components/products/ProductCart' // Reuse your existing product card component
...
export default function ProductsPage({ searchParams }: { searchParams: { category?: string } }) {
  ...
  return (
    <div className="grid grid-cols-24 min-h-screen">
      ...
      <aside className="hidden md:block md:col-span-4 lg:col-span-4 p-6 border-r">
      ...
      {mobileFiltersOpen && (
        <div className="fixed inset-0 bg-white z-50 p-6 overflow-y-auto md:hidden">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-4 flex justify-between">
            ...
            <Button className="w-full bg-[#E11D48]">Apply Filters</Button>
          </div>
        </div>
      )}
